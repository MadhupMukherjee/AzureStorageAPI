...
builder.Services.AddScoped<IAzureQueueService, AzureQueueBL>();
builder.Services.AddScoped<IAzureBlobService, AzureBlobBL>();
builder.Services.AddScoped<IAzureFileShare, FileShareBL>();
